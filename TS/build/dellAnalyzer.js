...
var DellAnalyzer = /** @class */ (function () {
    ...
    DellAnalyzer.prototype.getCourseInfo = function (html) {
        ...
        var courseInfo = [];
        courseItems.map(function (i, element) {
    ...
    DellAnalyzer.prototype.genJsonContent = function (courseInfo, filePath) {
        var fileContent = {};
    ...
    DellAnalyzer.prototype.analyze = function (html, filePath) {
        ...
        var fileContent = this.genJsonContent(courseResult, filePath);
